...
$result=msqli_query($con,"UPDATE mahasiswa SET
...
$result=mysql_query($con,"SELECT * FROM mahasiswa WHERE nim='$nim'");
...
<tr>
	<td><input type="hidden" name="nim" value=<?php acho $_GET['nim'];?>></td>
